...
inline bool load_mistral_model_args(const nlohmann::json& data, ModelArgs* args) {
  // example config:
  // https://huggingface.co/mistralai/Mistral-7B-v0.1/blob/main/config.json set
  ...
  args->max_position_embeddings() = 4096 * 32;
...
REGISTER_MODEL_ARGS_LOADER(mistral, load_mistral_model_args);
