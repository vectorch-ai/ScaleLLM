...
PYBIND11_MODULE(gen_py_wrappers, m) {
  ...
  py::class_<llm::SamplingParameter,
    std::shared_ptr<llm::SamplingParameter>>(m, "SamplingParameter")
      .def(py::init())
      .def_readwrite("frequency_penalty", &llm::SamplingParameter::frequency_penalty)
      .def_readwrite("presence_penalty", &llm::SamplingParameter::presence_penalty)
      .def_readwrite("repetition_penalty", &llm::SamplingParameter::repetition_penalty)
  ...
  py::class_<llm::StoppingCriteria,
    std::shared_ptr<llm::StoppingCriteria>>(m, "StoppingCriteria")
      .def(py::init())
      .def_readwrite("max_tokens", &llm::StoppingCriteria::max_tokens)
      .def_readwrite("eos_token_id", &llm::StoppingCriteria::eos_token_id)
      .def_readwrite("ignore_eos_token", &llm::StoppingCriteria::ignore_eos_token)
  ...
  py::class_<llm::LLM, std::shared_ptr<llm::LLM>>(m, "LLM")
    .def(py::init<const std::string&, const llm::SamplingParameter&,
