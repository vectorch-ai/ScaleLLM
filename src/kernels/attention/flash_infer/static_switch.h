...
#define DISPATCH_mask_mode(expr, const_expr, ...) \
  _DISPATCH_SWITCH(                               \
      "mask_mode", expr, _DISPATCH_CASES_mask_mode(const_expr, __VA_ARGS__))
