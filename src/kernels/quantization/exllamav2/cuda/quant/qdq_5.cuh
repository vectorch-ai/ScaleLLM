...
__forceinline__ __device__ void dequant_5bit_32(const uint32_t q_0,
                                                const uint32_t q_1,
                                                const uint32_t q_2,
                                                const uint32_t q_3,
                                                const uint32_t q_4,
...
__forceinline__ __device__ void dequant_5bit_32(const uint32_t q_0,
  ...
  for (int i = 0; i < 6; i++)
    dqh[13 + i] = dq_ns(exb(q_2, i * 5 + 1, 0x1f), 16);
  dqh[19] = dq_ns(exb(q_3, q_2, 31, 0x1f), 16);
  for (int i = 0; i < 5; i++)
    dqh[20 + i] = dq_ns(exb(q_3, i * 5 + 4, 0x1f), 16);
  dqh[25] = dq_ns(exb(q_4, q_3, 29, 0x1f), 16);
  for (int i = 0; i < 6; i++)
    dqh[26 + i] = dq_ns(exb(q_4, i * 5 + 2, 0x1f), 16);
