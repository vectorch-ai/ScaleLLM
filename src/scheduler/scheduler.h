...
class Scheduler {
 public:
  ...
  // run the scheduler until all pending + scheduled requests are completed, blocking call
  virtual void run_until_complete() = 0;

  // Following methods are used for tracking requests from user but have not been
  // scheduled yet. 
