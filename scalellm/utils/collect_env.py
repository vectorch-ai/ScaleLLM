...
# Run it with `python collect_env.py` or `python -m scalellm.utils.collect_env`
...
def get_gpu_topo(run_lambda):
    if get_platform() == 'linux':
        return run_and_read_all(run_lambda, 'nvidia-smi topo -mp')
    return "N/A"
...
def get_env_info():
    ...
    return SystemEnv(
        scalellm_version=get_scalellm_version(),
...
env_info_fmt = """
ScaleLLM version: {scalellm_version}
